...
const SplitFlapText = ({
  ...
  useEffect(() => {
    ...
    // eslint-disable-next-line react-hooks/set-state-in-effect -- vendored component (shadcn/react-bits); resets tile state to match new props before the animation loop below reads it
